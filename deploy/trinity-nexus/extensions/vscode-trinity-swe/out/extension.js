...
async function callTrinitySWE(request) {
...
function processCodeGen(request) {
...
function processBugFix(request) {
...
function processExplain(request) {
    const prompt = request.prompt.toLowerCase();
...
function processReason(request) {
    const prompt = request.prompt.toLowerCase();
...
function processRefactor(request) {
    return {
...
function processDocument(request) {
    return {
...
function activate(context) {
    ...
    statusBarItem.show();
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('trinity.generate', generateCode), vscode.commands.registerCommand('trinity.explain', explainCode), vscode.commands.registerCommand('trinity.fix', fixBug), vscode.commands.registerCommand('trinity.refactor', refactorCode), vscode.commands.registerCommand('trinity.reason', chainOfThoughtReasoning), vscode.commands.registerCommand('trinity.test', generateTest), vscode.commands.registerCommand('trinity.document', generateDocumentation), outputChannel, statusBarItem);
    outputChannel.appendLine('═══════════════════════════════════════════════════════════════');
