...
// notandI .vibee withandtoand and andwithandI and
// V = n × 3^k × π^m × φ^p × e^q
// φ² + 1/φ² = 3 = TRINITY
...
pub const SpecGenerator = struct {
    ...
    /// notandin[CYR:ate] withandtoand and andwithandI and
    ...
    /// notandin[CYR:ate] and onand within[CYR:go] to
