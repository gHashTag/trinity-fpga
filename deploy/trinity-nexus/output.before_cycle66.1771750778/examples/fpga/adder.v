// ═══════════════════════════════════════════════════════════════════════════════
// adder v1.0.0 - Generated Verilog from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Type: AdderInput
// Input for adder function
// Field: a -> [63:0] // 64-bit signed
// Field: b -> [63:0] // 64-bit signed
// Field: carry_in -> [63:0] // 64-bit signed

// Type: CounterInput
// Input for counter function
// Field: clk -> [63:0] // 64-bit signed
// Field: reset -> [63:0] // 64-bit signed
// Field: enable -> [0:0] // 1-bit boolean

// Type: Led_BlinkerInput
// Input for led_blinker function
// Field: clk -> [63:0] // 64-bit signed
// Field: reset -> [63:0] // 64-bit signed
// Field: speed -> [63:0] // 64-bit signed
...
adder_sacred_constants sacred_inst (
        .phi(phi),
        .phi_sq(phi_sq),
...
adder_top dut (
    ...
    initial begin
        $display("═══════════════════════════════════════════════════════════════");
$display("adder Testbench - φ² + 1/φ² = 3");
        $display("═══════════════════════════════════════════════════════════════");
