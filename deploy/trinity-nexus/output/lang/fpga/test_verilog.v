// ═══════════════════════════════════════════════════════════════════════════════
// blinky v1.0.0 - Generated Verilog from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
module blinky_sacred_constants (
...
blinky_sacred_constants sacred_inst (
        .phi(phi),
        .phi_sq(phi_sq),
...
module reset_logic (
// When: System resets
// Then: Counter goes to 0
module behavior_reset (
    input  wire        clk,
input  wire        rst_n,
    input  wire        trigger,
    input  wire [31:0] input_data,
...
assert_0_tick: assert property (p_tick)
else $error("Assertion failed: tick");

cover_0_tick: cover property (p_tick);
...
assert_1_reset: assert property (p_reset)
else $error("Assertion failed: reset");

cover_1_reset: cover property (p_reset);
...
blinky_top dut (
    ...
    initial begin
        $display("═══════════════════════════════════════════════════════════════");
$display("blinky Testbench - φ² + 1/φ² = 3");
        $display("═══════════════════════════════════════════════════════════════");
