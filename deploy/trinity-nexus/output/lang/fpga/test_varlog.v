// ═══════════════════════════════════════════════════════════════════════════════
// test_varlog v1.0.0 - Generated Verilog from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
module test_varlog_sacred_constants (
...
test_varlog_sacred_constants sacred_inst (
        .phi(phi),
        .phi_sq(phi_sq),
...
module testBehavior_logic (
// When: triggered
// Then: output
module behavior_testBehavior (
    input  wire        clk,
input  wire        rst_n,
    input  wire        trigger,
...
`ifdef FORMAL
module test_varlog_sva_checker (
    input wire        clk,
    input wire        rst_n,
    input wire [31:0] data_in,
    input wire        valid_in,
...
// When: triggered
// Then: output
property p_testBehavior;
@(posedge clk) disable iff (!rst_n)
1'b1 |-> 1'b1;
    endproperty

assert_0_testBehavior: assert property (p_testBehavior)
else $error("Assertion failed: testBehavior");

cover_0_testBehavior: cover property (p_testBehavior);
...
test_varlog_top dut (
    ...
    initial begin
        $display("═══════════════════════════════════════════════════════════════");
$display("test_varlog Testbench - φ² + 1/φ² = 3");
        $display("═══════════════════════════════════════════════════════════════");
