...
class Tri < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/gHashTag/trinity/releases/download/v5.1.0/tri-aarch64-macos.tar.gz"
      sha256 "tri-aarch64-macos-sha256-placeholder"  # TODO: Update on release
    else
      url "https://github.com/gHashTag/trinity/releases/download/v5.1.0/tri-x86_64-macos.tar.gz"
