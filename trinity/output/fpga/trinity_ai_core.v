// ═══════════════════════════════════════════════════════════════════════════════
// trinity_ai_core v1.0.0 - Generated Verilog from .tri specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
assert_0_init: assert property (p_init)
else $error("Assertion failed: init");

cover_0_init: cover property (p_init);
