...
public enum ThemeVariant: String, CaseIterable, Identifiable {
    ...
    var accentColor: UInt32 {
        // Returns default accent - overridden by user selection in TrinityTheme
        switch self {
...
struct TrinityTheme {
    ...
    @AppStorage("selectedAccentColor") static var selectedAccentColorRaw: String = AccentColor.green.rawValue
    @AppStorage("reduceMotionEnabled") static var reduceMotionEnabled: Bool = false
    @AppStorage("highContrastEnabled") static var highContrastEnabled: Bool = false
    ...
    static var selectedAccentColor: AccentColor {
    ...
    static func adaptiveAnimation(_ animation: @autoclosure () -> Animation) -> Animation {
    ...
    static var accent: Color {
        // Use user-selected accent color, with high contrast override if enabled
    ...
    static func accessibleAnimation() -> Animation {
    ...
    static func accessibleAccent(_ highContrast: Bool = highContrastEnabled) -> Color {
        highContrast ? HighContrast.accent : accent
    }

    /// Returns appropriate accent color for user-selected preference
    static func userAccent(_ color: AccentColor? = nil) -> Color {
    ...
    static var allAccentColors: [AccentColor] {
