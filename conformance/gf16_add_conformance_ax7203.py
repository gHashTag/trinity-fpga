#!/usr/bin/env python3
"""GF16 ADD compute-conformance on AX7203 (1S+6E+9M, bias=31, HAS_INF=True).

Golden = gf_ref.gf_add (exact Fraction oracle, family-split overflow: GF16 is
...
Result is 16 bits -> res_lo | (res_hi<<8).
  ...
  self-test:  python3 gf16_add_conformance_ax7203.py --self-test
  on HW:      python3 gf16_add_conformance_ax7203.py --port /dev/cu.usbserial-1120 --baud 160000
"""
