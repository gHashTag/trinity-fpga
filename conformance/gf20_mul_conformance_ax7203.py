#!/usr/bin/env python3
"""GF20 MUL compute-conformance on AX7203 (1S+7E+12M, bias=63, no Inf).

Golden = gf_ref.gf_mul (exact Fraction oracle, family-split overflow). Coverage =
...
4-byte response (3 result bytes).
  ...
  self-test:  python3 gf20_mul_conformance_ax7203.py --self-test
  on HW:      python3 gf20_mul_conformance_ax7203.py --port /dev/cu.usbserial-120 --baud 160000
"""
