...
module b_mxfp4 (input wire clk, input wire rst_n, output wire [3:0] led);
  ...
  blk32_mxfp4 u (.clk(clk),.rst_n(rst_n),.codes(cds),.acts(act),.e8m0(lf[39:32]),.emax(lf[47:40]),.y(y));
  wire [39:0] fz_y = y;
