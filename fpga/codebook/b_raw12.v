...
module b_raw12 (input wire clk, input wire rst_n, output wire [3:0] led);
  reg [63:0] lf = 64'h1234_5678_9ABC_DEF0;
  always @(posedge clk) lf <= !rst_n ? 64'h1234_5678_9ABC_DEF0 : {lf[62:0], lf[63]^lf[62]^lf[60]^lf[59]};
  wire [39:0] y;
  wire [383:0] wss = {7{lf[63:0]}};
  wire [127:0] cds = {lf[63:0], lf[63:0]} ^ {64'h0F0F_0F0F_0F0F_0F0F, lf[31:0], lf[63:32]};
  wire [255:0] act = {cds, cds} ^ {128'h0, lf[63:0], lf[63:0]};
  blk32_raw #(.WW(12)) u (.clk(clk),.rst_n(rst_n),.ws(wss),.acts(act),.e8m0(lf[39:32]),.emax(lf[47:40]),.y(y));
  wire [39:0] fz_y = y;
