# GF16 Multiplier Synthesis — QMTECH XC7A100T-FGG676
...
set top_module gf16_mul_top
set part_name xc7a100t-fgg676-1
set project_name gf16_mul
set output_dir ./gf16_mul_output

# ============================================================================
# CREATE PROJECT
# ============================================================================
puts "=========================================="
puts "GF16 Multiplier Synthesis"
...
# ADD SOURCE FILES
# ============================================================================
add_files -norecurse ./gf16_mul_top.v
