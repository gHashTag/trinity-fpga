...
`timescale 1ns / 1ps
// corona_decode_int4_ax7203 — INT4 signed -> INT32 sign-extension decode on AX7203.
// Single-decoder build: CFGMCLK clock, BAUD_DIV 434. Frame: AA 55 fmt code_lo code_hi
// trig -> A5 r0 r1 r2 r3. Identical infra to corona_decode_fp8_ax7203; only decoder differs.
module corona_decode_int4_ax7203 (
    ...
    wire [31:0] result;
    int4_decode u_dec (.int4_in(code_r[3:0]), .int32_out(result), .is_zero());
    assign led[2] = |result;
