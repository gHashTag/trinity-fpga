...
`timescale 1ns / 1ps
// corona_compute_gf8_bfp_fma_ax7203 — GF8_BFP FMA on AX7203.
module corona_compute_gf8_bfp_fma_ax7203 (
    ...
    wire gf_inf_c = (gf_exp_c == 3'd7) && (gf_mant_c == 0);
    wire gf_sub_c = (gf_exp_c == 3'd0) && (gf_mant_c != 0);
    wire [7:0] gf_exp32_c = gf_sub_c ? 8'd124 : ({5'd0, gf_exp_c} + 8'd124);
    wire [22:0] gf_mant32_c = {gf_mant_c, 19'b0};
    reg [31:0] fp32_c;
    always @(*) begin
        if(gf_zero_c) fp32_c=32'h00000000;
        else if(gf_nan_c) fp32_c=32'h7FC00000;
        else if(gf_inf_c) fp32_c={gf_sign_c, 8'hFF, 23'b0};
        else fp32_c={gf_sign_c, gf_exp32_c, gf_mant32_c};
    end
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(add_ovld) result_reg<={24'b0,q_result};
        end
    end
