...
`timescale 1ns / 1ps
// corona_compute_gf8_bfp_to_fp32_ax7203 — GF8_BFP TO_FP32 on AX7203.
module corona_compute_gf8_bfp_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [7:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                3'd4: begin frame_valid<=1;frm<=0; end
            endcase end
        end
    end
