...
`timescale 1ns / 1ps
// corona_decode_fp6_e2m3_ax7203 — FP6 E2M3 (Blackwell) decode on AX7203.
...
module corona_decode_fp6_e2m3_ax7203 (
    ...
    wire [31:0] result;
    fp6_e2m3_decode u_dec (.fp6_in(code_r[5:0]), .fp32_out(result), .is_zero());
    assign led[2] = |result;
