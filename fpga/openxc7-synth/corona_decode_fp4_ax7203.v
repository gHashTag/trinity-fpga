...
`timescale 1ns / 1ps
// corona_decode_fp4_ax7203 — FP4 E2M1 (OCP MX) decode on AX7203 (16-entry LUT).
...
module corona_decode_fp4_ax7203 (
    ...
    wire [31:0] result;
    fp4_decode u_dec (.fp4_in(code_r[3:0]), .fp32_out(result));
    assign led[2] = |result;
