...
// =============================================================================
// HSLM 4-BLOCK TOP — Four Stacked TrinityBlocks on FPGA
// =============================================================================
// x[i]=i+1 → TrinityBlock₁ → TrinityBlock₂ → TrinityBlock₃ → TrinityBlock₄ → self-test → LED
//
// Resources: ~7,000 LUT (~11%), ~128 BRAM36 (95%)
// Latency: ~28.8 ms @ 50 MHz (4 × 7.2 ms)
//
...
module hslm_4block_top (
    ...
    // Inter-block buffer 3: Block3 → Block4
    ...
    localparam ST_START_B4 = 4'd8;
    localparam ST_RUN_B4   = 4'd9;
    ...
    // =====================================================================
    // UART TX + REPORTER (frame type 0x99 for 4-block)
    // =====================================================================
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (!report_sent && st_state == ST_DONE && !report_sending) begin
                ...
                report_frame[2]  <= 8'h99;  // 0x99 = hslm 4-block
