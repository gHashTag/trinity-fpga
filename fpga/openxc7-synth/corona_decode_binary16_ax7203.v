...
`timescale 1ns / 1ps
// corona_decode_binary16_ax7203 — IEEE 754 binary16 (half) decode on AX7203.
// binary16_decode is authored in-repo and EXHAUSTIVELY verified (65536/65536 vs
// the C-library binary16 via struct 'e'). Single-decoder build: CFGMCLK clock,
...
module corona_decode_binary16_ax7203 (
    ...
    wire [31:0] result;
    binary16_decode u_dec (.b16_in(code_r[15:0]), .fp32_out(result), .is_zero(), .is_inf(), .is_nan());
    assign led[2] = |result;
