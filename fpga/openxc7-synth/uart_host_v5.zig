// VSA FPGA UART Host v5.0
// Day 5: Tiny BitNet Inference via UART
//
// New features:
// - BITNET command (0x05): run tiny inference
// - runModel(prompt_id) → returns token
// - All Day 2/3/4 commands preserved

const std = @import("std");
var prng = std.Random.DefaultPrng.init(12345);

// === COMMANDS (Day 5 Protocol) ===
...
pub fn main() !void {
    ...
    std.debug.print("╔════════════════════════════════════════╗\n", .{});
    std.debug.print("║     VSA FPGA UART Host v5.0           ║\n", .{});
    std.debug.print("╚════════════════════════════════════════╝\n", .{});
