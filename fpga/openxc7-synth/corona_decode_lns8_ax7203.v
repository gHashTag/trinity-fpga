...
`timescale 1ns / 1ps
// corona_decode_lns8_ax7203 — 8-bit LNS (base-2) decode on AX7203.
// lns8_decode returns a TUPLE (sign_out, magnitude[15:0], is_zero), NOT fp32.
// PACKING CONTRACT (must match conformance/corona_decode_host_ax7203.py::_lns8):
//   result[31]    = sign_out
//   result[30:16] = 0
//   result[15:0]  = magnitude (16-bit Q8.8 antilog)
// Single-decoder build: CFGMCLK clock, BAUD_DIV 434. Frame: AA 55 fmt code_lo
// code_hi trig -> A5 r0 r1 r2 r3. Identical infra to corona_decode_fp8_ax7203.
module corona_decode_lns8_ax7203 (
    ...
    // PACKING CONTRACT: {sign_out, 15'b0, magnitude[15:0]}
    wire        lns_sign;
    wire [15:0] lns_mag;
    wire        lns_iszero;
    lns8_decode u_dec (.lns_in(code_r[7:0]), .sign_out(lns_sign), .magnitude(lns_mag), .is_zero(lns_iszero));
    wire [31:0] result = {lns_sign, 15'b0, lns_mag};
    assign led[2] = |result;
