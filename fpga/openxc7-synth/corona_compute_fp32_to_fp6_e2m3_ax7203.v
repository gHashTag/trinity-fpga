...
`timescale 1ns / 1ps
// corona_compute_fp32_to_fp6_e2m3_ax7203 — FP6_E2M3 FP32_TO on AX7203.
module corona_compute_fp32_to_fp6_e2m3_ax7203 (
    ...
    reg [5:0] rv;
    always @(*) begin
        if(fn) rv={1'b0,{2{1'b1}},{2{1'b0}},1'b1};
        else if(fi) rv={fs,{2{1'b1}},{3{1'b0}}};
        else if(fz) rv={6{1'b0}};
        else rv={fs,fe[1:0],fm[22:20]};
    end
    always @(posedge mclk or posedge rst) begin
