...
`timescale 1ns / 1ps
// corona_decode_gfternary_ax7203 — GFTernary 2-bit decode on AX7203.
// Frame: AA 55 fmt code_lo code_hi trig -> A5 r0 r1 r2 r3 (FP32 LE).
// Only code_lo[1:0] is used (2-bit format); upper bits ignored.
module corona_decode_gfternary_ax7203 (
    ...
    wire [31:0] result;
    gfternary_decode u_dec (.gft_in(code_r[1:0]), .fp32_out(result));
    assign led[2] = |result;
