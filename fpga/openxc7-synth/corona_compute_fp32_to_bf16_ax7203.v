...
`timescale 1ns / 1ps
// corona_compute_fp32_to_bf16_ax7203 — BF16 FP32_TO on AX7203.
module corona_compute_fp32_to_bf16_ax7203 (
    ...
    reg [15:0] rv;
    always @(*) begin
        if(fn) rv={1'b0,{8{1'b1}},{6{1'b0}},1'b1};
        else if(fi) rv={fs,{8{1'b1}},{7{1'b0}}};
        else if(fz) rv={16{1'b0}};
        else rv={fs,fe[7:0],fm[22:16]};
    end
    always @(posedge mclk or posedge rst) begin
