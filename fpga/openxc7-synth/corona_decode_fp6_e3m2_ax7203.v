...
`timescale 1ns / 1ps
// corona_decode_fp6_e3m2_ax7203 — FP6 E3M2 (OCP MX) decode on AX7203.
...
module corona_decode_fp6_e3m2_ax7203 (
    ...
    wire [31:0] result;
    fp6_e3m2_decode u_dec (.fp6_in(code_r[5:0]), .fp32_out(result));
    assign led[2] = |result;
