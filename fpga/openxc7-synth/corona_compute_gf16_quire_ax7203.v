...
`timescale 1ns / 1ps
// corona_compute_gf16_quire_ax7203 — GF16 QUIRE on AX7203.
module corona_compute_gf16_quire_ax7203 (
    ...
    gf_quire_param #(.EXP_BITS(8), .MANT_BITS(23), .HAS_INF(1)) u_comp (
        .clk(mclk),.rst(rst),.in_valid(comp_trigger),.in_a(fp32_a),.in_b(32'h0),
