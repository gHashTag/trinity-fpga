...
- **Total Tier-E HW (rigorous, §1.1): 71/83** (decode 41 + compute 30; 2026-07-02). **decimal64 + decimal32 + decimal128 + double_double + takum16 + quad_double PROVEN on HW** (6 track-b cells; decimal family 32/64/128 COMPLETE). Remaining: ~10 structural (no decode law — unreachable) + takum32/64 (transcendental exp, research-level). **SW-bitexact = 69/83** (t27 PRs merged).
