...
run gfplus8L "gfplus8_a_decode dec (.word_in(lf[7:0]), .pocket(lf[9:8]), .fp32_out(fp), .is_zero());" "gfplus8_a_decode.v"
run gfplus8C "gfplus8_a_decode dec (.word_in(lf[7:0]), .pocket(2'b00), .fp32_out(fp), .is_zero());" "gfplus8_a_decode.v"
