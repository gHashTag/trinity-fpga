...
# UART TX (FPGA → ESP32/Mac) - E26
set_property -dict {PACKAGE_PIN E26 IOSTANDARD LVCMOS33} [get_ports uart_tx]

# UART RX (ESP32/Mac → FPGA) - D26
set_property -dict {PACKAGE_PIN D26 IOSTANDARD LVCMOS33} [get_ports uart_rx]
