...
// =============================================================================
// gf20_clean_ax7203 — GF20 ADD HW-conformance engine (1S+7E+12M, bias=63, no Inf).
...
// Adder core = gf_adder_param #(EXP_BITS=7, MANT_BITS=12) (validated SW for all
...
module gf20_clean_ax7203 (
    ...
    gf_adder_param #(.EXP_BITS(7), .MANT_BITS(12)) u_add (
        .clk(mclk), .rst(rst),
