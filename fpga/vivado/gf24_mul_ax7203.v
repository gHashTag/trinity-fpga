...
// =============================================================================
// gf24_mul_ax7203 — GF24 ADD HW-conformance engine (1S+9E+14M, bias=255, no Inf).
...
module gf24_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(9), .MANT_BITS(14)) u_add (
        .clk(mclk), .rst(rst),
