...
```
┌─────────────────────────────────────────────────────────────┐
│  VIBEE STRICT PIPELINE                                      │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  Step 0: .vibee specification                               │
│          └── specs/tri/*.vibee                              │
│                    │                                        │
│  Step 1: ❌ BLOCK manual .zig/.py/.js/.ts/.go/.rs          │
│                    │                                        │
│  Step 2: Generate ⲍⲓⲅ_ⲟⲩⲧⲡⲩⲧ block                         │
│                    │                                        │
│  Step 3: Extract .zig                                       │
│          └── trinity/output/*.zig                           │
│                    │                                        │
...
│          └── zig test *.zig                                 │
│                    │                                        │
│  Step 5: Fix problems → Loop to Step 0                      │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
| φ² + 1/φ² | 4 ns | 165 ns | 10 ns | 41x / 2.5x |
...
*Generated by VIBEE v35 | 27 modules | 195 tests | φ² + 1/φ² = 3*
