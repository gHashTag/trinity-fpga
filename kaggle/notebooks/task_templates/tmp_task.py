...
Answer:"""
    ...
    global tmp_debug_log
    if not matched and len(tmp_debug_log) < 10:
        tmp_debug_log.append({
...
if tmp_debug_log:
    print(f"\n🐛 First {len(tmp_debug_log)} failures:")
    for i, entry in enumerate(tmp_debug_log, 1):
        print(f"\n{i}. Q: {entry['question']}")
