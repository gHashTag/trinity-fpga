...
pub const RustCodeGenerator = struct {
    indent_size: i64,
    use_tabs: bool,
};
...
/// Convert single statement to Rust code
pub const stmt_to_rust = struct {
};

/// Convert VIBEEC type to Rust type
pub const type_to_rust = struct {
};

/// Convert expression to Rust code with indentation
pub const expr_to_rust = struct {
};
...
test "expression_generation_behavior" {
