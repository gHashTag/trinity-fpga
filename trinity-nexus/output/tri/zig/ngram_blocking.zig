...
test "baseline_has_repeats" {
// Given: "No penalty, T=0.3, 30 words from 'to be'"
...
test "blocking_removes_repeats" {
// Given: "alpha=1.2, block=true, T=0.3, 30 words"
