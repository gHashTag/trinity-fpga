...
// Test buildAssociativeMemory: verify behavior is callable (compile-time check)
_ = buildAssociativeMemory;
}
...
// Test singleHopQuery: verify behavior is callable (compile-time check)
_ = singleHopQuery;
}
