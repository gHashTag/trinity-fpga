...
// When: |
// Then: 8 position-encoded Hypervectors
// Test positionEncode: verify behavior is callable (compile-time check)
_ = positionEncode;
}
...
// When: |
// Then: Predicted character (or null if no match)
// Test feedForwardAndDecode: verify behavior is callable (compile-time check)
_ = feedForwardAndDecode;
}
