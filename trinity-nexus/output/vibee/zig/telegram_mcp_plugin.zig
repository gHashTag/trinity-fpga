// ═══════════════════════════════════════════════════════════════════════════════
// telegram_mcp v>=3.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// Filter criteria for listing dialogs
pub const - = struct {
    -: name: unread_only,
    @"type": bool,
