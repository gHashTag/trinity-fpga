...
// ═══════════════════════════════════════════════════════════════════════════════
// rest_api v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: POST /resources
// Then: Resource created with 201
// Test case: input={name: "Test", value: "123"}, expected={status: "201", created: "true"}
// Test case: input={name: "", value: ""}, expected={status: "400", error: "Invalid data"}
}
...
// When: GET /resources/:id
// Then: Resource returned with 200
// Test case: input={id: "1"}, expected={status: "200", found: "true"}
// Test case: input={id: "999"}, expected={status: "404", error: "Not found"}
}
...
// When: PUT /resources/:id
// Then: Resource updated with 200
// Test case: input={id: "1", name: "Updated"}, expected={status: "200", updated: "true"}
}
...
// When: DELETE /resources/:id
// Then: Resource deleted with 204
// Test case: input={id: "1"}, expected={status: "204", deleted: "true"}
}
...
// When: GET /resources
// Then: Resources returned with 200
// Test case: input={}, expected={status: "200", count: "10"}
}
