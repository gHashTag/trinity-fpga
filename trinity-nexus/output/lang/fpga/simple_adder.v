// ═══════════════════════════════════════════════════════════════════════════════
// simple_adder v1.0.0 - Generated Verilog from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
module simple_adder_sacred_constants (
...
// Field: a -> [0:0] // 1-bit boolean
// Field: b -> [0:0] // 1-bit boolean
// Field: carry_in -> [0:0] // 1-bit boolean

// ═══════════════════════════════════════════════════════════════════════════════
// TOP MODULE
// ═══════════════════════════════════════════════════════════════════════════════

module simple_adder_top (
    input  wire        clk,
input  wire        rst_n,
...
simple_adder_sacred_constants sacred_inst (
        .phi(phi),
        .phi_sq(phi_sq),
...
simple_adder_top dut (
    ...
    initial begin
        $display("═══════════════════════════════════════════════════════════════");
$display("simple_adder Testbench - φ² + 1/φ² = 3");
        $display("═══════════════════════════════════════════════════════════════");
