...
/// Then: - Write section header "КОНСТАНТЫ"
pub fn writeConstants(items: anytype) !void {
// TODO: implement — - Write section header "КОНСТАНТЫ"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
...
/// Then: - Write section header "ТИПЫ"
pub fn writeTypes(items: anytype) !void {
// TODO: implement — - Write section header "ТИПЫ"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
