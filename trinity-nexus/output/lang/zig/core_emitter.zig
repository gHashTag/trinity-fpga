...
/// Then: - Write section header "[CYR:[TRANSLATED]A[TRANSLATED]]"
pub fn writeConstants(items: anytype) !void {
// TODO: implement — - Write section header "[CYR:[TRANSLATED]A[TRANSLATED]]"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
...
/// Then: - Write section header "[CYR:[TRANSLATED]]"
pub fn writeTypes(items: anytype) !void {
// TODO: implement — - Write section header "[CYR:[TRANSLATED]]"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
