...
/// Then: - Write section header "[CYR:КОНСТАНТЫ]"
pub fn writeConstants(items: anytype) !void {
// TODO: implement — - Write section header "[CYR:КОНСТАНТЫ]"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
...
/// Then: - Write section header "[CYR:ТИПЫ]"
pub fn writeTypes(items: anytype) !void {
// TODO: implement — - Write section header "[CYR:ТИПЫ]"
    // Add 'implementation:' field in .vibee spec to provide real code.
_ = items;
}
