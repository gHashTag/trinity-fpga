// ═══════════════════════════════════════════════════════════════════════════════
// curly_braces v10.1.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TestListTypes = struct {
    strings: []const u8,
    ints: []const i64,
    floats: []const f64,
    bools: []const bool,
    nested_strings: []const []const u8,
    optional_int: ?i64,
    list_optional: []const ?i64,
    optional_list: ?[]const u8,
};
...
/// VIBEE spec with nested generic types
...
test "bracket_parsing_test_behavior" {
// Given: VIBEE spec with nested generic types
// When: Parser extracts inner types
// Then: - Correct opening bracket position found
// Test bracket_parsing_test: verify behavior is callable (compile-time check)
_ = bracket_parsing_test;
}
