// NeoDetect Inject Script - Runs in page context (MAIN world)
...
(function() {
  ...
  // Read state from the script element's dataset
  const scriptEl = document.currentScript;
  if (!scriptEl) return;

  let state;
  try {
    state = JSON.parse(scriptEl.dataset.state);
  } catch (e) {
    return;
  }
  ...
  if (state.navigatorProtect && state.profile) {
    ...
    if (state.profile.screenWidth && state.profile.screenHeight) {
      try {
        Object.defineProperty(Screen.prototype, 'width', { get: () => state.profile.screenWidth, configurable: true });
        Object.defineProperty(Screen.prototype, 'height', { get: () => state.profile.screenHeight, configurable: true });
        Object.defineProperty(Screen.prototype, 'availWidth', { get: () => state.profile.screenWidth, configurable: true });
        Object.defineProperty(Screen.prototype, 'availHeight', { get: () => state.profile.screenHeight - 40, configurable: true });
        Object.defineProperty(Screen.prototype, 'colorDepth', { get: () => state.profile.colorDepth || 24, configurable: true });
        Object.defineProperty(Screen.prototype, 'pixelDepth', { get: () => state.profile.colorDepth || 24, configurable: true });
      } catch (e) {}
    }

    if (state.profile.pixelRatio) {
      try {
        Object.defineProperty(window, 'devicePixelRatio', { get: () => state.profile.pixelRatio, configurable: true });
      } catch (e) {}
    }
  ...
  if (state.navigatorProtect && state.profile) {
    ...
    const spoofedUserAgentData = {
      ...
      toJSON: function() {
        return { brands: this.brands, mobile: false, platform: platform };
      }
    };
