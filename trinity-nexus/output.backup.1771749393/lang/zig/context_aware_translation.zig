...
// When: Translation to Russian requested
// Then: Cultural equivalent returned
// Test case: input={idiom: "break_a_leg", target: "russian"}, expected={translation: "and  and ", confidence: 0.95}
// Test case: input={idiom: "raining_cats_and_dogs", target: "russian"}, expected={translation: " toto and in", confidence: 0.90}
}
...
// When: Full translation requested
// Then: Contextually appropriate translation returned
// Test case: input={text: "Break a leg!", context: "Theater"}, expected={translation: "and  and !", confidence: 0.95}
}
