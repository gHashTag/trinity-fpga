...
pub fn processSpec(path: []const u8) !void {
...
pub fn generateStruct() []const u8 {
...
pub fn generateBehavior() []const u8 {
...
pub fn validateOutput(path: []const u8) bool {
...
pub fn getStats(self: *@This()) !void {
...
// When: Maps types, generates structs, behaviors, and tests for target language
// Then: Returns GeneratedFile with idiomatic code
// Test generateForTarget: verify behavior is callable (compile-time check)
_ = generateForTarget;
}
...
// When: Emits method/function stub with doc comments from given/when/then
// Then: Returns code string for the behavior
// Test generateBehavior: verify behavior is callable (compile-time check)
_ = generateBehavior;
}
...
// When: Processes all specs, generating code for all targets
// Then: Returns list of CodegenResults
// Test batchProcess: verify behavior is callable (compile-time check)
_ = batchProcess;
}
