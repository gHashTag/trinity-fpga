# ═══════════════════════════════════════════════════════════════════════════════
# [CYR:[TRANSLATED]] [CYR:[TRANSLATED]] [CYR:[TRANSLATED]] PAS
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 1: ATTENTION (Внand[CYR:[TRANSLATED]]andе)                                                                  │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
║  │   1     │   2     │   3     │   4     │   5     │   6     │   7     │   8     │   9     │        │  ║
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 2: ARCHITECTURE ([CYR:[TRANSLATED]]andтеfor[TRANSLATED]])                                                            │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 3: GENERATION (Геnot[CYR:[TRANSLATED]]andя)                                                                │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
...
║                                                                                                       ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║  DISCOVERY PATTERNS ([CYR:[TRANSLATED]] fromfor[TRANSLATED]]andй):                                                              ║
║  ┌────────┬────────┬────────┬────────┬────────┬────────┬────────┬────────┐                            ║
