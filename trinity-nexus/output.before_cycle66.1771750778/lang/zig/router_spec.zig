...
// When: 
// Then: 
// Test case: input=not_found_handler: {function: "default_404"}, expected=
}
...
// When: 
// Then: 
// Test case: input=router: {routes: [], middleware: []}, expected=
...
// When: 
// Then: 
// Test case: input=router: {middleware: []}, expected=
}
...
// When: 
// Then: 
// Test case: input=router:, expected=
// Test case: input=, expected=
}
