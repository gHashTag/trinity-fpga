// ═══════════════════════════════════════════════════════════════════════════════
// list_utils v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: sum_list is called
// Then: Sum of all numbers is returned
// Test case: input=list: "[1, 2, 3, 4, 5]", expected=
// Test case: input=list: "[1, -2, 3, -4, 5]", expected=
// Test case: input=list: "[]", expected=
}
...
// When: max_value is called
// Then: Maximum value is returned
// Test case: input=list: "[1, 5, 3, 9, 2]", expected=
// Test case: input=list: "[-5, -2, -8, -1]", expected=
}
...
// When: unique is called
// Then: List with unique values is returned
// Test case: input=list: "[1, 2, 2, 3, 3, 3, 4]", expected=
// Test case: input=list: "[1, 2, 3, 4]", expected=
}
...
// When: chunk is called
// Then: List of chunks is returned
// Test case: input=list: "[1, 2, 3, 4, 5, 6]", expected=
// Test case: input=list: "[1, 2, 3, 4, 5]", expected=
}
