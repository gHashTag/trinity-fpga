// ═══════════════════════════════════════════════════════════════════════════════
// cursor_integration v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: User runs "Generate spec.yml" command
// Then: spec.yml created in current directory
// Test case: input=selection: "Create user login feature", expected=
// Test case: input=prompt: "Blog system with CRUD", expected=
}
...
// When: User types behavior name
// Then: Cursor suggests Given-When-Then template
// Test case: input=typed: "- name: user_", expected=
// Test case: input=typed: "test_cases:", expected=
}
...
// When: Cursor validates the spec
// Then: Errors shown inline if invalid
// Test case: input=spec: "valid spec.yml", expected=
// Test case: input=spec: "spec.yml missing behaviors", expected=
}
