...
// Test case: input={text: "Good morning", source: "english", target: "russian"}, expected={translation: "[CYR:[EN]] [CYR:[EN]]", confidence: 1.0}
}
...
// When: translate function called
// Then: Russian technical term returned
// Test case: input={text: "compiler", source: "english", target: "russian"}, expected={translation: "to[CYR:[EN]]and[CYR:[EN]]", confidence: 1.0}
// Test case: input={text: "algorithm", source: "english", target: "russian"}, expected={translation: "[CYR:[EN]]and[EN]", confidence: 1.0}
}
...
// When: translate function called
// Then: Russian sentence with correct grammar returned
// Test case: input={text: "I love programming", source: "english", target: "russian"}, expected={translation: "[EN] [CYR:[EN]] [CYR:[EN]]and[EN]in[EN]and[EN]", confidence: 0.95}
// Test case: input={text: "We are building a compiler", source: "english", target: "russian"}, expected={translation: "[EN] with[CYR:[EN]]and[EN] to[CYR:[EN]]and[CYR:[EN]]", confidence: 0.95}
}
