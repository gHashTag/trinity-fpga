...
// When: Translation to Russian requested
// Then: Cultural equivalent returned
// Test case: input={idiom: "break_a_leg", target: "russian"}, expected={translation: "[EN]and [CYR:[EN]] [EN]and [CYR:[EN]]", confidence: 0.95}
// Test case: input={idiom: "raining_cats_and_dogs", target: "russian"}, expected={translation: "[CYR:[EN]] to[EN]to and[EN] in[CYR:[EN]]", confidence: 0.90}
}
...
// When: Full translation requested
// Then: Contextually appropriate translation returned
// Test case: input={text: "Break a leg!", context: "Theater"}, expected={translation: "[EN]and [CYR:[EN]] [EN]and [CYR:[EN]]!", confidence: 0.95}
}
