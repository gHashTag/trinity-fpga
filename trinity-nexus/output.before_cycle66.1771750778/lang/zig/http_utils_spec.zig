// ═══════════════════════════════════════════════════════════════════════════════
// http_utils v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: http_get is called
// Then: GET request is made and response is returned
// Test case: input=url: "https://api.example.com/users", expected=
// Test case: input=url: "https://api.example.com/notfound", expected=
}
...
// When: http_put is called
// Then: PUT request is made and response is returned
// Test case: input=url: "https://api.example.com/users/123", expected=
}
...
// When: parse_json_response is called
// Then: JSON is parsed into data structure
// Test case: input=body: "{\"id\": \"123\", \"name\": \"John\"}", expected=
}
...
// When: build_query_string is called
// Then: Query string is built
// Test case: input=params: "{\"page\": \"1\", \"limit\": \"10\"}", expected=
// Test case: input=params: "{\"q\": \"hello world\"}", expected=
}
