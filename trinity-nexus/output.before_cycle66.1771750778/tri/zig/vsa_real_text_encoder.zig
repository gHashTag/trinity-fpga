...
// When: Encoding single n-gram
// Then: Bind char vectors with position permutation
// Test realEncodeNGram: verify behavior is callable (compile-time check)
_ = realEncodeNGram;
}
...
// When: Combining into document vector
// Then: Bundle all n-gram vectors via majority vote
// Test realBundleNGrams: verify behavior is callable (compile-time check)
_ = realBundleNGrams;
}
...
// When: Verifying reproducibility
// Then: Both encodings produce identical vectors
// Test realTextDeterminism: verify behavior is callable (compile-time check)
_ = realTextDeterminism;
}
