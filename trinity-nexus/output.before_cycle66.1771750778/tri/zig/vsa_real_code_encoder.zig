...
/// Single code token
/// VSA ops: Encoding token to hypervector
...
// Test realTokenEncoding: verify behavior is callable (compile-time check)
_ = realTokenEncoding;
}
...
// When: Combining into code vector
// Then: Bundle all tokens via majority vote
// Test realTokenBundling: verify behavior is callable (compile-time check)
_ = realTokenBundling;
}
