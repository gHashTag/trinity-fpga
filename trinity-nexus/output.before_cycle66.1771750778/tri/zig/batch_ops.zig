...
// ═══════════════════════════════════════════════════════════════════════════════
        ...
        pub fn processBindBatch(items: []const BatchItem) !void {
            _ = items;
        }



        pub fn processBundleBatch(items: []const BatchItem) !void {
            _ = items;
        }
...
test "batch_faster_than_sequential" {
