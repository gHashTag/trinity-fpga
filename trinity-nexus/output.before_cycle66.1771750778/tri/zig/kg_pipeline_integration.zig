// ═══════════════════════════════════════════════════════════════════════════════
// kg_pipeline_integration v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MIN_TRIPLE_CONFIDENCE: f64 = 0.6;
...
/// LLM response text and a mutable ChatKnowledgeGraph reference
...
pub fn extractAndStoreTriples(input: []const u8) !void {
// Extract: Each qualifying triple is stored via addFact(subject, predicate, object)
...
/// An ExtractedTriple with confidence score
...
test "filterByConfidence_behavior" {
