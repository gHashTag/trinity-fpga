...
pub fn main() !void {
    ...
    // Load tokenizer
    std.debug.print("\nLoading tokenizer...\n", .{});
    var tokenizer = try Tokenizer.load(allocator, "../../data/models/bitnet/tokenizer.json");
...
test "tokenizer load" {
    ...
    var tokenizer = Tokenizer.load(allocator, "../../data/models/bitnet/tokenizer.json") catch |err| {
