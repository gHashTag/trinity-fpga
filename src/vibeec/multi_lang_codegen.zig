// ═══════════════════════════════════════════════════════════════════════════════
// MULTI-LANGUAGE CODEGEN - [EN]not[CYR:[EN]] to[EN]yes for inwith[EN] [CYR:[EN]]to[EN]in
// ═══════════════════════════════════════════════════════════════════════════════
//
// Generates code for 39 [CYR:[EN]]to[EN]in and[EN] .vibee with[CYR:[EN]]and[EN]andto[EN]and[EN]
