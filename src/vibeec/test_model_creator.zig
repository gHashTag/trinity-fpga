// TEST MODEL CREATOR - [CYR:[EN]]yes[EN]and[EN] test[EN]in[EN] [CYR:[EN]]and
// Generates small safetensors file for testand[EN]in[EN]and[EN]
// φ² + 1/φ² = 3 = TRINITY
...
pub fn main() !void {
    ...
    // [CYR:[EN]]yes[EN] JSON [CYR:[EN]]in[EN]to
    const header =
