...
pub const Coordinator = struct {
    ...
    fn detectTaskType(query: []const u8) TaskType {
        ...
        if (std.mem.indexOf(u8, query, "write code") != null or
            ...
            std.mem.indexOf(u8, query, "onand to") != null or
        ...
        if (std.mem.indexOf(u8, query, "explain") != null or
            ...
            std.mem.indexOf(u8, query, "withand") != null)
        {
        ...
        if (std.mem.indexOf(u8, query, "debug") != null or
            ...
            std.mem.indexOf(u8, query, "andwithin") != null)
        {
        ...
        if (std.mem.indexOf(u8, query, "analyze") != null or
            ...
            std.mem.indexOf(u8, query, "onand") != null)
        {
            return .Analysis;
        }
        ...
        if (std.mem.indexOf(u8, query, "summarize") != null or
            ...
            std.mem.indexOf(u8, query, "toto") != null)
        {
...
pub fn runBenchmark() void {
    ...
    const scenarios = [_]struct {
        ...
        // Multilingual
        .{ .query = "onand to for withandintoand", .feedback = .ThumbsUp },
        .{ .query = "onand result", .feedback = .Acceptance },
