...
// 16-[CYR:байтный] vector for SIMD [CYR:операц]andй
...
pub const SIMDBigramMatcher = struct {
    // [CYR:Топ]-16 бand[CYR:грамм] for SIMD tuning ([CYR:пер]inый character)
    first_chars: Vec16,
    // [CYR:Топ]-16 бand[CYR:грамм] for SIMD tuning (in[CYR:торой] character)
    second_chars: Vec16,
...
// [CYR:Топ]-100 [CYR:англ]andйwithtoandх withлоin/byдwithлоin for BPE
...
// [CYR:Хэш]-[CYR:табл]andца for быwith[CYR:трого] tuning BPE тоto[CYR:ено]in
