...
pub const CodeGen = struct {
    ...
    fn visitNode(self: *CodeGen, node: *const AstNode) error{OutOfMemory}!void {
        switch (node.kind) {
            ...
            .let_destructure_array, .let_destructure_object => {}, // DEFERRED (v12): codegen for destructuring (requires temp variables, element extraction)
            .rest_pattern => {},
...
// ═══════════════════════════════════════════════════════════════════════════════
// notand Verilog toyes for withand on FPGA
// and: BitNet operation (Ternary MAC  and)
// φ² + 1/φ² = 3
...
pub const VerilogGen = struct {
    ...
    fn visitFuncDeclVerilog(self: *VerilogGen, node: *const AstNode) !void {
        //  Verilog toand withinwith and or always toand
