// ═══════════════════════════════════════════════════════════════════════════════
// encoding_to_zig.zig — Text Encoding Codegen (Island 2)
// ═══════════════════════════════════════════════════════════════════════════════
// Generates Codebook struct and encoding functions from .tri spec
// φ² + 1/φ² = 3 | TRINITY
// ═══════════════════════════════════════════════════════════════════════════════
...
// Full implementation template (imports ops for bind/bundle/permute)
const ENCODING_IMPL =
...
pub fn generate(allocator: Allocator, source: []const u8) ![]const u8 {
    ...
    try output.appendSlice(allocator, ENCODING_IMPL);

    // Add tests
    try output.appendSlice(allocator,
        \\
        \\test "Codebook initialization" {
