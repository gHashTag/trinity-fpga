// @origin(spec:tri_math.tri) @regen(manual-impl)
...
// =============================================================================
// SACRED CONSTANTS (imported from math/sacred_constants_data.zig)
// =============================================================================
...
const PHI_INV = data.PHI_INV;
const PHI_INV_SQ = data.PHI_INV_SQ;
const PI = data.PI;
const E = data.E;
const TRANSCENDENTAL = data.TRANSCENDENTAL;
const TRINITY = data.TRINITY;
const MU = data.MU;
const CHI = data.CHI;
const SIGMA = data.SIGMA;
const EPSILON = data.EPSILON;
const CHSH = data.CHSH;
const FINE_STRUCTURE_INV = data.FINE_STRUCTURE_INV;
const SQRT2 = data.SQRT2;
const SQRT3 = data.SQRT3;
const SQRT5 = data.SQRT5;
const EULER_MASCHERONI = data.EULER_MASCHERONI;
const LN2 = data.LN2;
const APERY = data.APERY;
const CATALAN = data.CATALAN;
const FEIGENBAUM_DELTA = data.FEIGENBAUM_DELTA;
const FEIGENBAUM_ALPHA = data.FEIGENBAUM_ALPHA;
const KHINCHIN = data.KHINCHIN;
const GLAISHER_KINKELIN = data.GLAISHER_KINKELIN;
const OMEGA = data.OMEGA;
const PLASTIC = data.PLASTIC;
const LANDAU_RAMANUJAN = data.LANDAU_RAMANUJAN;
const CONWAY = data.CONWAY;
const ALPHA = data.ALPHA;
const PLANCK_H = data.PLANCK_H;
const PLANCK_HBAR = data.PLANCK_HBAR;
const SPEED_OF_LIGHT = data.SPEED_OF_LIGHT;
const BOLTZMANN = data.BOLTZMANN;
const GRAVITATIONAL = data.GRAVITATIONAL;
const AVOGADRO = data.AVOGADRO;
const ELEMENTARY_CHARGE = data.ELEMENTARY_CHARGE;
const PLANCK_LENGTH = data.PLANCK_LENGTH;
const PLANCK_TIME = data.PLANCK_TIME;
const PLANCK_MASS = data.PLANCK_MASS;
const PHI_SQRT = data.PHI_SQRT;
const GOLDEN_HALF = data.GOLDEN_HALF;
const PHI_TO_PHI = data.PHI_TO_PHI;
const PHI_TO_PI = data.PHI_TO_PI;
const NUCLEAR_MAGIC = data.NUCLEAR_MAGIC;
const NP_STABILITY = data.NP_STABILITY;
const BINDING_PEAK = data.BINDING_PEAK;
const SIERPINSKI_DIM = data.SIERPINSKI_DIM;
const KOCH_DIM = data.KOCH_DIM;
const MENGER_DIM = data.MENGER_DIM;
const MANDELBROT_DIM = data.MANDELBROT_DIM;
const GOLDEN_SPIRAL_RATIO = data.GOLDEN_SPIRAL_RATIO;
const BERRY_PHASE_QUTRIT = data.BERRY_PHASE_QUTRIT;
const SU3_F123 = data.SU3_F123;
const SU3_F458 = data.SU3_F458;
const SU3_CASIMIR = data.SU3_CASIMIR;
const SU3_GOLDEN = data.SU3_GOLDEN;
const QUTRIT_GATE_ANGLE = data.QUTRIT_GATE_ANGLE;
const RYDBERG = data.RYDBERG;
const PLANCK_TEMPERATURE = data.PLANCK_TEMPERATURE;
const PLANCK_ENERGY_GEV = data.PLANCK_ENERGY_GEV;
const WEINBERG_SIN2 = data.WEINBERG_SIN2;
const PROTON_ELECTRON_RATIO = data.PROTON_ELECTRON_RATIO;
const PLANCK_LENGTH_PHI = data.PLANCK_LENGTH_PHI;
const PLANCK_TIME_PHI = data.PLANCK_TIME_PHI;
const QUTRIT_ENTROPY = data.QUTRIT_ENTROPY;
const BERRY_PHI_ORBIT = data.BERRY_PHI_ORBIT;
const BEKENSTEIN_HAWKING_RATIO = data.BEKENSTEIN_HAWKING_RATIO;
const HOLOGRAPHIC_BITS = data.HOLOGRAPHIC_BITS;
const HAWKING_COEFF = data.HAWKING_COEFF;
const UNRUH_COEFF = data.UNRUH_COEFF;
const BARBERO_IMMIRZI = data.BARBERO_IMMIRZI;
const BARBERO_IMMIRZI_J1 = data.BARBERO_IMMIRZI_J1;
const BROWN_HENNEAUX = data.BROWN_HENNEAUX;
const SCHWARZSCHILD_AREA_COEFF = data.SCHWARZSCHILD_AREA_COEFF;
const REGGE_SLOPE = data.REGGE_SLOPE;
const HOLOGRAPHIC_PHI = data.HOLOGRAPHIC_PHI;
const BARBERO_IMMIRZI_PHI = data.BARBERO_IMMIRZI_PHI;
const CARDY_COEFF = data.CARDY_COEFF;
const PLANCK_AREA = data.PLANCK_AREA;
const M_ELECTRON = data.M_ELECTRON;
const M_PROTON = data.M_PROTON;
const M_NEUTRON = data.M_NEUTRON;
const M_W_BOSON = data.M_W_BOSON;
const M_Z_BOSON = data.M_Z_BOSON;
const M_HIGGS = data.M_HIGGS;
const M_U_QUARK = data.M_U_QUARK;
const M_D_QUARK = data.M_D_QUARK;
const M_S_QUARK = data.M_S_QUARK;
const M_C_QUARK = data.M_C_QUARK;
const M_B_QUARK = data.M_B_QUARK;
const M_T_QUARK = data.M_T_QUARK;
const MUON_ELECTRON_RATIO = data.MUON_ELECTRON_RATIO;
const TAU_ELECTRON_RATIO = data.TAU_ELECTRON_RATIO;
const STRANGE_ELECTRON_RATIO = data.STRANGE_ELECTRON_RATIO;
const TOP_ELECTRON_RATIO = data.TOP_ELECTRON_RATIO;
const MUON_ELECTRON_ALT = data.MUON_ELECTRON_ALT;
const TAU_ELECTRON_ALT = data.TAU_ELECTRON_ALT;
const PROTON_ELECTRON_ALT = data.PROTON_ELECTRON_ALT;
const SIN2_THETA12_PMNS = data.SIN2_THETA12_PMNS;
const SIN2_THETA23_PMNS = data.SIN2_THETA23_PMNS;
const SIN2_THETA13_PMNS = data.SIN2_THETA13_PMNS;
const THETA_CABIBBO_DEG = data.THETA_CABIBBO_DEG;
const E8_DIM = data.E8_DIM;
const E8_ROOTS = data.E8_ROOTS;
const M_THEORY_DIM = data.M_THEORY_DIM;
const STRING_DIM = data.STRING_DIM;
const SPACE_DIM = data.SPACE_DIM;
const PARTICLE_GENERATIONS = data.PARTICLE_GENERATIONS;
const QUARK_COLORS = data.QUARK_COLORS;
const CHERN_MAX_MOD = data.CHERN_MAX_MOD;
const BOTT_MAX = data.BOTT_MAX;
const SKYRMION_RADIUS_NM = data.SKYRMION_RADIUS_NM;
const SKYRMION_CHARGE = data.SKYRMION_CHARGE;
const MERON_CHARGE = data.MERON_CHARGE;
const MAGIC_184 = data.MAGIC_184;
const ISLAND_OF_STABILITY_Z = data.ISLAND_OF_STABILITY_Z;
const A_BOHR = data.A_BOHR;
const SIGMA_STEFAN_BOLTZMANN = data.SIGMA_STEFAN_BOLTZMANN;
const B_WIEN = data.B_WIEN;
const LAMBDA_COMPTON = data.LAMBDA_COMPTON;
const MU_BOHR = data.MU_BOHR;
const RHO_CRITICAL = data.RHO_CRITICAL;
const OMEGA_CDM = data.OMEGA_CDM;
const OMEGA_K = data.OMEGA_K;
const SPECTRAL_INDEX = data.SPECTRAL_INDEX;
const SIGMA_8_COSMO = data.SIGMA_8_COSMO;
const HUBBLE_SH0ES = data.HUBBLE_SH0ES;
const HUBBLE_PREDICTED = data.HUBBLE_PREDICTED;
const TRIDEVYATITSA = data.TRIDEVYATITSA;
const SACRED_MULTIPLIER = data.SACRED_MULTIPLIER;
const SACRED = data.SACRED;
const CHSH_CLASSICAL = data.CHSH_CLASSICAL;
const TAU_LIF = data.TAU_LIF;
const ENERGY_EFFICIENCY = data.ENERGY_EFFICIENCY;
const LOIHI_CORES = data.LOIHI_CORES;
const NORTHPOLE_CORES = data.NORTHPOLE_CORES;
const YBCO_TC = data.YBCO_TC;
const MGB2_TC = data.MGB2_TC;
const H3S_TC = data.H3S_TC;
const JIUZHANG_PHOTONS = data.JIUZHANG_PHOTONS;
const TYPICAL_FIDELITY = data.TYPICAL_FIDELITY;
const COHERENCE_TIME_US = data.COHERENCE_TIME_US;
const ALPHA_INV_SACRED = data.ALPHA_INV_SACRED;
const ALPHA_INV_ALT = data.ALPHA_INV_ALT;
const FIBONACCI_TABLE = data.FIBONACCI_TABLE;
const LUCAS_TABLE = data.LUCAS_TABLE;
...
const HUBBLE = data.HUBBLE;
const OMEGA_MATTER = data.OMEGA_MATTER;
const OMEGA_LAMBDA = data.OMEGA_LAMBDA;
const OMEGA_BARYON = data.OMEGA_BARYON;
const CMB_TEMP = data.CMB_TEMP;
const AGE_UNIVERSE = data.AGE_UNIVERSE;
const DARK_ENERGY_W = data.DARK_ENERGY_W;
