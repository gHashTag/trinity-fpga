...
fn showMathHelp() !void {
    ...
    try wr.writeAll("║  tri math identities             Show φ-identities               ║\n");
    try wr.writeAll("║                                                                    ║\n");
    ...
    try wr.writeAll("║                                                                    ║\n");
    try wr.writeAll("╚════════════════════════════════════════════════════════════════════╝\n");
    try wr.writeAll(format.colors.reset);
}
