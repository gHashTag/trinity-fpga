...
test "tower_of_hanoi: number of disks" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 50
...
test "tower_of_hanoi: formula result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 7
        \\    ST t0, 55
...
test "tower_of_hanoi: is optimal" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 57
...
test "edit_distance: string 1 length" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 6
        \\    ST t0, 50
...
test "edit_distance: string 2 length" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 7
        \\    ST t0, 51
...
test "edit_distance: matches target" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 53
...
test "edit_distance: similarity percent" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 57
        \\    ST t0, 54
