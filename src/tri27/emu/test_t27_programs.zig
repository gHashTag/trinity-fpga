...
test "climb_stairs: number of stairs" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 50
...
test "min_stack: min after 2 pops" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 53
...
test "sqrt_newton: initial guess" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 8
        \\    ST t0, 51
...
test "sqrt_newton: iteration 1 result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 52
...
test "sqrt_newton: iteration 2 result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 4
        \\    ST t0, 53
...
test "sqrt_newton: verify result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 16
        \\    ST t0, 55
...
test "valid_parentheses: string length" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 6
        \\    ST t0, 50
...
test "valid_parentheses: count after first '('" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 51
...
test "valid_parentheses: count after ')'" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 0
        \\    ST t0, 52
...
test "valid_parentheses: is valid result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 57
...
test "valid_parentheses: balanced opens and closes" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 62
...
test "binary_search: array length" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 7
        \\    ST t0, 50
...
test "binary_search: target value" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 7
        \\    ST t0, 51
...
test "binary_search: result index" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 57
...
test "binary_search: iterations count" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 58
...
test "binary_search: worst case iterations" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 63
...
test "binary_search: not found result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, -1
        \\    ST t0, 65
...
test "two_pointers: array length" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 6
        \\    ST t0, 50
...
test "two_pointers: initial left pointer" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 0
        \\    ST t0, 52
...
test "two_pointers: initial right pointer" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 53
...
test "two_pointers: first iteration sum" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 7
        \\    ST t0, 56
...
test "two_pointers: second iteration sum" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 8
        \\    ST t0, 60
...
test "two_pointers: result left index" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 2
        \\    ST t0, 66
...
test "two_pointers: result right index" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 67
...
test "two_pointers: iterations count" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 68
...
test "merge: first merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 120
...
test "merge: second merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 2
        \\    ST t0, 121
...
test "merge: third merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 122
...
test "merge: fourth merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 4
        \\    ST t0, 123
...
test "merge: fifth merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 124
...
test "merge: sixth merged element" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 6
        \\    ST t0, 125
...
test "heapify: left child of root" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 5
        \\    ST t0, 52
...
test "heapify: right child of root" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 4
        \\    ST t0, 53
...
test "heapify: heap property satisfied" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 54
...
test "heapify: internal nodes count" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 57
...
test "dfs: third visited (deepest first)" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 62
...
test "dfs: fourth visited (backtrack)" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 2
        \\    ST t0, 63
...
test "dfs: discovery time of node 3" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 56
...
// ═══════════════════════════════════════════════════════════════════════════════
// longest_increasing_subsequence.t27 Tests
// ═══════════════════════════════════════════════════════════════════════════════

test "lis: file exists" {
    const allocator = std.testing.allocator;
    const path = "src/tri27/longest_increasing_subsequence.t27";
    const file = try std.fs.cwd().readFileAlloc(allocator, path, 100000);
    defer allocator.free(file);
...
test "knapsack: dp at capacity 3" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 4
        \\    ST t0, 63
...
test "knapsack: dp at capacity 7" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 9
        \\    ST t0, 67
...
test "knapsack: first selected item" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 70
...
test "knapsack: second selected item" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 2
        \\    ST t0, 71
...
test "fibonacci: identity property holds" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 59
...
test "fibonacci: coprime property" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 1
        \\    ST t0, 61
...
test "gcd: input a" {
    ...
    ;
    const cpu = try runWithInput(allocator, program, &[_]i64{});
    try std.testing.expectEqual(@as(i64, 48), cpu.t27[0].trits);
}
...
test "gcd: a divisible by result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 8
        \\    ST t0, 56
...
test "gcd: b divisible by result" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 57
...
test "gcd: extended coefficient x" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, -1
        \\    ST t0, 61
...
test "gcd: extended coefficient y" {
    const allocator = std.testing.allocator;
    const program =
        \\    LDI t0, 3
        \\    ST t0, 62
