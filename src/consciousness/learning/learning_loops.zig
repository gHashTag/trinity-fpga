...
// For build.zig: use module import, for standalone test: define inline
const sacred_mod = if (@import("builtin").is_test)
    struct {
        pub const math = struct {
            ...
            pub const TAU: f64 = 6.2831853071795864769;
            pub const PI: f64 = 3.14159265358979323846;
            pub const E: f64 = 2.71828182845904523536;
        };
        pub const physics = struct {
            pub const PHOENIX: f64 = 1.131;
        };
    }
else
    @import("sacred");
pub const PHI = sacred_mod.math.PHI;
pub const PHI_INV = sacred_mod.math.PHI_INV;
pub const PHI_SQ = sacred_mod.math.PHI_SQ;
pub const TRINITY = sacred_mod.math.TRINITY;
pub const SQRT5 = sacred_mod.math.SQRT5;
pub const TAU = sacred_mod.math.TAU;
pub const PI = sacred_mod.math.PI;
pub const E = sacred_mod.math.E;
pub const PHOENIX = sacred_mod.physics.PHOENIX;
...
pub const LearningLoop = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !LearningLoop {
        const empty_config = LearningConfig{
            .learning_rate = 0.01,
            .decay_factor = 0.95,
    ...
    /// Clean up resources
    pub fn deinit(self: *LearningLoop) void {
        // Currently using static slices, nothing to free
        _ = self;
    }
};
...
pub fn hebbian_learn(_: std.mem.Allocator) !void {
...
pub fn novelty_detection(_: std.mem.Allocator) error{OutOfMemory}!f32 {
    // Idiomatic Zig: errdefer for error diagnostics
    errdefer |err| {
        std.debug.print("Error in behavior: {}\n", .{err});
    }
