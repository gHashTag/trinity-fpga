// ═══════════════════════════════════════════════════════════════════════════════
// SPEC COMPILER - Full .tri → .zig Code Generator
// ═══════════════════════════════════════════════════════════════════════════════
//
// Generates COMPLETE Zig code from .tri specifications:
//   - Structs from types
...
pub const SpecCompiler = struct {
    ...
    fn writeHeader(self: *Self, spec: *const Spec) !void {
        try self.writeLine("// ═══════════════════════════════════════════════════════════════════════════════");
        try self.writeFmt("// {s} v{s} - AUTO-GENERATED from .tri specification\n", .{ spec.name, spec.version });
        try self.writeLine("// ═══════════════════════════════════════════════════════════════════════════════");
        try self.writeLine("//");
