// ═══════════════════════════════════════════════════════════════════════════════
// UNIVERSAL VARLOG GENERATOR - Геnot[CYR:рац]andя Verilog andз [CYR:ЛЮБЫХ] .vibee specs
// ═══════════════════════════════════════════════════════════════════════════════
//
// Generates Verilog HDL for [CYR:ВСЕХ] .vibee with[CYR:пец]andфandtoацandй (and[CYR:гнор]and[CYR:рует] language field)
