...
// TVC Runtime Demo - withand by andto inbynotand
...
fn testModuleExecution(runtime: *tvc_runtime.TVCRuntime, allocator: std.mem.Allocator) !void {
    ...
    std.debug.print("✓ toand trinary_logic inbynoton\n", .{});
}
