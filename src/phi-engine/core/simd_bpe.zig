...
// 16-byte vector for SIMD операций
...
pub const SIMDBigramMatcher = struct {
    // Top-16 bigrams for SIMD поиска (первый character)
    first_chars: Vec16,
    // Top-16 bigrams for SIMD поиска (второй character)
    second_chars: Vec16,
...
// Top-100 English words/подслов for BPE
...
// Hash table for fast lookup BPE токенов
...
// WebSocket streaming for агентов
