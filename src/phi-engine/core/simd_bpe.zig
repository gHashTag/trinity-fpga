...
// 16-byte vector for SIMD [CYR:[EN]]and[EN]
...
pub const SIMDBigramMatcher = struct {
    // Top-16 bigrams for SIMD tuning ([CYR:[EN]]in[EN] character)
    first_chars: Vec16,
    // Top-16 bigrams for SIMD tuning (in[CYR:[EN]] character)
    second_chars: Vec16,
...
// Top-100 English words/by[EN]with[EN]in for BPE
...
// Hash table for fast lookup BPE [EN]to[CYR:[EN]]in
...
// WebSocket streaming for agent[EN]in
