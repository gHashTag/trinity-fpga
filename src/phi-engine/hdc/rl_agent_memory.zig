...
//!
//! Agent with long-term memory for storing experience.
//! withby Streaming Memory for experience replay.
//!
//! φ² + 1/φ² = 3 | TRINITY
...
pub const RLAgentWithMemory = struct {
    ...
    /// and experience in memory
    pub fn storeExperience(self: *RLAgentWithMemory, exp: Experience) !void {
        // Encode experience how to-value
        // : state_id + action_id
        // onand: reward + next_state + done
