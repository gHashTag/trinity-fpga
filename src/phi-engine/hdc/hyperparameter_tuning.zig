//! Hyperparameter Tuning - andwithto and parameterin for 100% win rate
//!
//! :
...
pub fn runGridSearch(allocator: std.mem.Allocator) !void {
    print("\n", .{});
    print("╔══════════════════════════════════════════════════════════════╗\n", .{});
    print("║     HYPERPARAMETER TUNING -  PERFECT AGENT          ║\n", .{});
    ...
    const num_runs: usize = 3; // not by 3 withto
