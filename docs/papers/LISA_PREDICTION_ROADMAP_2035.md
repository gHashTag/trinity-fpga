...
1. **Phase accuracy:** Better than 10⁻³ radians for EMRI detection
2. **Frequency calibration:** Better than 10⁻⁶ Hz
3. **Timing precision:** Better than 1 second across mission lifetime
...
1. ISCO frequencies match GR within 1% (no φ⁻¹ shift)
2. GW phase evolution shows no γ correction
3. Ringdown frequencies match GR within 5%
4. Chirp masses from GW and EM observations agree within 1%
...
1. TRINITY theory requires revision
2. γ = φ⁻³ may not apply to strong-field regime
3. Alternative φ-relationships needed
