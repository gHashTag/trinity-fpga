...
| Phase | Symbol | Color | Meaning |
|-------|--------|-------|---------|
| SEED | 🌱 | Green | Potential state |
| SPROUT | 🌿 | Light Green | Emerging awareness |
| BUD | 🌷 | Yellow | Preparatory focus |
| BLOOM | 🪷 | Pink | Full integration |
| WITHER | 🍂 | Brown | Rest/release |

## Files

- Metadata: `docs/research/.zenodo.B004_v8.0.json`
