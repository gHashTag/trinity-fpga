# ═══════════════════════════════════════════════════════════════════════════════
# [CYR:ПЕРИОДИЧЕСКАЯ] [CYR:ТАБЛИЦА] [CYR:АЛГОРИТМОВ] PAS
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 1: ATTENTION (Внand[CYR:ман]andе)                                                                  │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
║  │   1     │   2     │   3     │   4     │   5     │   6     │   7     │   8     │   9     │        │  ║
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 2: ARCHITECTURE ([CYR:Арх]andтеto[CYR:тура])                                                            │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
...
║                                                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │ PERIOD 3: GENERATION (Геnot[CYR:рац]andя)                                                                │  ║
║  ├─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┬─────────┤        │  ║
...
║                                                                                                       ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║  DISCOVERY PATTERNS ([CYR:Паттерны] fromto[CYR:рыт]andй):                                                              ║
║  ┌────────┬────────┬────────┬────────┬────────┬────────┬────────┬────────┐                            ║
