...
has no representation at all from $c=20$ upward, marked ---.}
\label{tab:window}
...
format. Both tensors sit below $2^{12}$ and both lose.}
...
sixteen physical cells, as does \texttt{takum16}.}
\label{tab:centring}
\begin{tabular}{lrrrr}
\hline
...
earlier absolute window was stated in.}
\label{tab:landing}
\begin{tabular}{lrrr}
\hline
