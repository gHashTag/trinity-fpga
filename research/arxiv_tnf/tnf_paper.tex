...
Among the twenty formats carrying their own range --- those a training run can
live in --- GFTernary leads on throughput per area, by $10.2\%$ over the next and
$6.1\times$ over \texttt{posit32}, with eight of the twenty ours. Formats needing
an external learned scale are tabulated apart. On an XC7A200T a ternary neuron
...
Five retractions are marked in place below.
\end{abstract}
