...
Eight of our own claims were falsified by the measurements meant to support them,
...
compared. The last two are in Section~\ref{sec:sixteen} and were falsified
inside a single iteration: a caveat this paper computed rather than measured,
and a sentence defending our own first place.
...
\toprule
& format & storage & LUT & BRAM & MHz/LUT & five-seed range & conformance \\
\midrule
1 & \textbf{GFTernary} (ours) & 2 bits & 527 & 0 & \textbf{0.1574} & $0.1524$--$0.1616$ & all 4 codes \\
2 & binary32 & 32 bits & 536 & 0 & 0.1422 & $0.1376$--$0.1474$ & identity (exact) \\
3 & fp8 e4m3 & 8 bits & 549 & 0 & 0.1244 & $0.1133$--$0.1322$ & all 256, 0 wrong \\
4 & \textbf{TNF16a} (ours) & 16b & 566 & 0 & \textbf{0.1233} & $0.1192$--$0.1278$ & all 65{,}534 \checkmark \\
5 & fp8 e5m2 & 8 bits & 544 & 0 & 0.1214 & $0.1168$--$0.1252$ & all 256, 0 wrong \\
6 & \textbf{TNF17e} (ours) & 17b & 596 & 0 & \textbf{0.1207} & $0.1135$--$0.1238$ & all 124{,}416 \checkmark \\
7 & \textbf{GF10} (ours) & 10 bits & 597 & 0 & \textbf{0.1189} & $0.1134$--$0.1204$ & all 1{,}024 \\
8 & \textbf{TNF32} (ours) & 36 bits & 569 & 0 & \textbf{0.1176} & $0.1137$--$0.1243$ & sampled 9{,}997, 0 wrong \\
9 & \textbf{TNF16c} (ours) & 16b & 591 & 0 & \textbf{0.1157} & $0.1118$--$0.1210$ & all 62{,}208 \checkmark \\
10 & \textbf{TNF64} (ours) & 65 bits & 572 & 0 & \textbf{0.1143} & $0.1061$--$0.1214$ & sampled, 0 wrong \\
11 & \textbf{TNF64b-bare} (ours) & 65b & 573 & 0 & \textbf{0.1095} & $0.1028$--$0.1155$ & sweep pending \\
12 & minifloat & 8 bits & 622 & 0 & 0.1075 & $0.1009$--$0.1132$ & all 254 \checkmark \\
13 & \textbf{GF14} (ours) & 14 bits & 651 & 0 & \textbf{0.1074} & $0.0969$--$0.1140$ & all 16{,}384 \\
14 & \textbf{TNF17e-bare} (ours) & 17b & 605 & 0 & \textbf{0.1072} & $0.1041$--$0.1104$ & sweep pending \\
15 & \textbf{TNF8} (ours) & 10 bits & 609 & 0 & \textbf{0.1069} & $0.1028$--$0.1099$ & all 1{,}024, 0 wrong \\
16 & \textbf{TNF16b} (ours) & 16b & 604 & 0 & \textbf{0.1048} & $0.0998$--$0.1086$ & all 65{,}534 \checkmark \\
17 & binary16 & 16 bits & 586 & 0 & 0.1039 & $0.0985$--$0.1071$ & all 65{,}536 \\
18 & \textbf{BNF16} (ours) & 17 bits & 635 & 0 & \textbf{0.1034} & $0.0961$--$0.1064$ & all 131{,}072, 0 wrong \\
19 & \textbf{TNF64b} (ours) & 65b & 626 & 0 & \textbf{0.1007} & $0.0944$--$0.1018$ & sweep pending \\
20 & \textbf{TNF16} (ours) & 17 bits & 629 & 0 & \textbf{0.1005} & $0.0971$--$0.1071$ & all 131{,}072 \\
21 & VAX F & 32 bits & 624 & 0 & 0.0942 & $0.0926$--$0.1000$ & all 40{,}000 \checkmark \\
22 & \textbf{GF+8} (ours) & 8b (+2 sel) & 692 & 0 & \textbf{0.0882} & $0.0831$--$0.0931$ & 1{,}024/1{,}024 \checkmark \\
23 & posit8 & 8 bits & 614 & 0 & 0.0728 & $0.0712$--$0.0774$ & all 255 \checkmark \\
24 & takum16 & 16 bits & 853 & 57 & 0.0695 & $0.0677$--$0.0745$ & 632/61{,}505 \\
25 & LNS16 & 16 bits & 722 & 0 & 0.0598 & $0.0581$--$0.0600$ & 107/65{,}536 \\
26 & posit16 & 16 bits & 731 & 0 & 0.0485 & $0.0467$--$0.0496$ & all 65{,}535 \checkmark \\
27 & posit32 & 32 bits & 1031 & 0 & 0.0302 & $0.0291$--$0.0314$ & all 40{,}000 \checkmark \\
28 & IBM hex32 & 32 bits & 1072 & 0 & 0.0292 & $0.0273$--$0.0297$ & all 40{,}000 \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
36 & \textbf{TNF32} & 569 & 66.91 & 0.1176 \\
65 & \textbf{TNF64} & 572 & 65.38 & 0.1143 \\
65 & \textbf{TNF64b-bare} & 573 & 62.73 & 0.1095 \\
65 & \textbf{TNF64b} & 626 & 63.05 & 0.1007 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{TNF17e}    & $5$ & $5.1\%$  & $\mathbf{0.1312}$ & \textbf{yes} \\
\bottomrule
\end{tabular}
\end{center}

\noindent
$11.9\%$ faster per LUT \emph{while} checking its offset field, which the rung
it replaces does not. The same rule sends the $65$-bit rung from $E_t=7$, the
worst waste in the range at $46.6\%$, to $E_t=8$ at $19.9\%$ for one mantissa
bit; that rung is generated and referenced here but not yet swept.
...
GFTernary & 3 & 4 & 75.0\% \\
TNF64b & 159{,}931 & 200{,}000 & 80.0\% (sampled) \\
...
TNF32 & 199{,}634 & 200{,}000 & 99.8\% (sampled) \\
TNF64 & 199{,}900 & 200{,}000 & 100.0\% (sampled) \\
TNF64b-bare & 199{,}950 & 200{,}000 & 100.0\% (sampled) \\
