...
componentwise, and a layer's linear path is exact. Machine-checked in Coq. A set that is not closed must return every accumulation to it, costing an order
of magnitude more area.
...
On an XC7A200T a ternary neuron costs $28$ LUT per weight, $32.4$ with one
pipeline stage at $126.73$\,MHz, and \emph{no DSP at any fan-in}.
...
one adder. On the block axis the element is closed --- the best eight-level codebook beats
a deployed one by $0.9\%$ --- and the scale is not: a $\varphi$ grid at four bits
beats MXFP4 on two models at $0.125$ fewer bits per weight.
...
\begin{table}[t]\centering
\caption{Throughput per area among formats that carry their own range,
re-measured. One ternary-neuron datapath, XC7A200T, no DSP anywhere,
\emph{every bit of both accumulator registers folded into the observed output},
median of five placement seeds. \texttt{int8} is not here: it has $e=0$ and
functions only beside an external learned scale, so it is reported in
Table~\ref{tab:rejected} with its measurement. Twenty formats; eight are ours,
spanning all four families. The last column is the seed spread and it decides
which neighbouring rows these data separate --- rows 3 to 5 lie within $1.1\%$
against spreads of $5.6$ to $10.2$, and should be read as tied.}
...
2 & binary32 & 32 bits & 472 & 77.00 & 0.1631 & $6.37$ \\
3 & \textbf{TNF32} (ours) & 32 bits & 492 & 75.57 & \textbf{0.1536} & $10.15$ \\
4 & \textbf{TNF64} (ours) & 64 bits & 494 & 75.16 & \textbf{0.1521} & $7.87$ \\
5 & \textbf{TNF16} (ours) & 16 bits & 510 & 77.47 & \textbf{0.1519} & $5.62$ \\
6 & \textbf{BNF16} (ours) & 16 bits & 518 & 74.94 & \textbf{0.1447} & $12.28$ \\
7 & \textbf{GF+8} (ours) & 8 bits & 510 & 72.84 & \textbf{0.1428} & $4.77$ \\
8 & fp8 e5m2 & 8 bits & 480 & 67.06 & 0.1397 & $5.46$ \\
9 & VAX F & 32 bits & 527 & 73.51 & 0.1395 & $4.43$ \\
10 & fp8 e4m3 & 8 bits & 485 & 67.02 & 0.1382 & $6.78$ \\
11 & \textbf{GF10} (ours) & 10 bits & 533 & 72.16 & \textbf{0.1354} & $5.08$ \\
12 & binary16 & 16 bits & 522 & 63.30 & 0.1213 & $7.74$ \\
13 & \textbf{GF14} (ours) & 14 bits & 587 & 71.15 & \textbf{0.1212} & $4.54$ \\
14 & minifloat & 8 bits & 558 & 67.06 & 0.1202 & $5.49$ \\
15 & posit8 & 8 bits & 540 & 44.33 & 0.0821 & $4.02$ \\
16 & takum16 & 16 bits & 789 & 58.96 & 0.0747 & $5.75$ \\
17 & IBM hex32 & 32 bits & 687 & 46.78 & 0.0681 & $3.78$ \\
18 & LNS16 & 16 bits & 658 & 43.04 & 0.0654 & $0.45$ \\
19 & posit16 & 16 bits & 712 & 40.38 & 0.0567 & $1.02$ \\
20 & posit32 & 32 bits & 953 & 28.16 & 0.0295 & $2.29$ \\
\bottomrule
\end{tabular}
\end{table}
