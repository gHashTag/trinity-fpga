...
beat the squared-error-optimal one, which is a \emph{sign} inversion where ours
is a magnitude disagreement.
...
Qwen    & $17.1\%$ & $23.3\%$ & $\mathbf{1.36\times}$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrrr}
\toprule
claim variant & SmolLM2 & Qwen & ratio \\
\midrule
...
perplexity, best encoder both sides    & $9.50\%$  & $7.18\%$  & $1.32\times$ \\
perplexity, against Algorithm~1        & $20.25\%$ & $9.16\%$  & $\mathbf{2.21\times}$ \\
\bottomrule
\end{tabular}
\end{center}
...
four is the combination most often quoted.}
\end{proposition}
