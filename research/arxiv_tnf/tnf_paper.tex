...
grid at four bits beats MXFP4 on two models at $0.125$ fewer bits per weight.
...
conformance. One ternary-neuron datapath, XC7A200T, no DSP, every accumulator bit observed. The \textsc{sd} column gives the seed count per row: rows swept at fifty-four seeds report the \emph{mean} and a $95\%$ interval, rows at five report the median and the observed range. \texttt{int8} is in
...
unsynthesised logic. \textbf{Resolution.} The pooled coefficient of variation across seeds is $3.71\%$, so two rows at five seeds separate at $\alpha=.05$ only when their MHz/LUT differ by more than $5.50\%$ relative, and two rows at fifty-four seeds only above $1.43\%$; smaller gaps than the applicable threshold are not results. The detection floor for a difference in \emph{decoder} cost is $41.3$ LUT, which is $79\%$ of a whole decoder at the median row --- the $472$-LUT harness inflates that floor tenfold. Every row is measured on the same $128$-bit harness; rows that were not have been re-measured or withdrawn.}\label{tab:fullthroughput}
\small
\tiny
\begin{tabular}{rlrrrrlll}
\toprule
& format & bits & LUT & MHz/LUT & $\pm$/range & sd & status & conformance \\
\midrule
1 & \textbf{GFTernary} & 2 bits & 527 & \textbf{0.1584} & $\pm0.0018$ & 54 & ours & all 4 codes \\
2 & binary32 & 32 bits & 536 & 0.1429 & $\pm0.0013$ & 54 & --- & identity (exact) \\
3 & fp8 e4m3 & 8 bits & 549 & 0.1225 & $\pm0.0012$ & 54 & --- & all 256, 0 wrong \\
4 & \textbf{TNF16a} & 16b & 566 & \textbf{0.1214} & $\pm0.0012$ & 54 & legacy & all 65{,}534 \checkmark \\
5 & fp8 e5m2 & 8 bits & 544 & 0.1188 & $\pm0.0011$ & 54 & --- & all 256, 0 wrong \\
6 & \textbf{GF10} & 10 bits & 597 & \textbf{0.1172} & $\pm0.0012$ & 54 & ours & all 1{,}024 \\
7 & \textbf{TNF17e} & 17b & 596 & \textbf{0.1155} & $\pm0.0013$ & 54 & \textbf{rec.} & all 124{,}416 \checkmark \\
8 & \textbf{TNF16c} & 16b & 591 & \textbf{0.1152} & $\pm0.0010$ & 54 & \textbf{rec.} & all 62{,}208 \checkmark \\
9 & \textbf{TNF16a-guarded} & 16b & 613 & \textbf{0.1079} & $\pm0.0011$ & 54 & control & all 41{,}472 \checkmark \\
10 & binary16 & 16 bits & 586 & 0.1078 & $\pm0.0012$ & 54 & --- & all 65{,}536 \\
11 & minifloat & 8 bits & 622 & 0.1075 & $0.1009$--$0.1132$ & 5 & --- & all 254 \checkmark \\
12 & \textbf{GF14} & 14 bits & 651 & \textbf{0.1074} & $0.0969$--$0.1140$ & 5 & ours & all 16{,}384 \\
13 & \textbf{TNF17e-bare} & 17b & 605 & \textbf{0.1072} & $0.1041$--$0.1104$ & 5 & control & sweep pending \\
14 & \textbf{TNF8} & 10 bits & 609 & \textbf{0.1069} & $0.1028$--$0.1099$ & 5 & legacy & all 1{,}024, 0 wrong \\
15 & \textbf{TNF16b} & 16b & 604 & \textbf{0.1048} & $0.0998$--$0.1086$ & 5 & legacy & all 65{,}534 \checkmark \\
16 & \textbf{BNF16} & 17 bits & 635 & \textbf{0.1034} & $0.0961$--$0.1064$ & 5 & legacy & all 131{,}072, 0 wrong \\
17 & \textbf{TNF16} & 17 bits & 629 & \textbf{0.1005} & $0.0971$--$0.1071$ & 5 & legacy & all 131{,}072 \\
18 & VAX F & 32 bits & 624 & 0.0942 & $0.0926$--$0.1000$ & 5 & --- & all 40{,}000 \checkmark \\
19 & \textbf{GF+8} & 8b (+2 sel) & 692 & \textbf{0.0882} & $0.0831$--$0.0931$ & 5 & ours & 1{,}024/1{,}024 \checkmark \\
20 & posit8 & 8 bits & 614 & 0.0728 & $0.0712$--$0.0774$ & 5 & --- & all 255 \checkmark \\
21 & takum16 & 16 bits & 853 & 0.0695 & $0.0677$--$0.0745$ & 5 & --- & 632/61{,}505 \\
22 & LNS16 & 16 bits & 722 & 0.0598 & $0.0581$--$0.0600$ & 5 & --- & 107/65{,}536 \\
23 & posit16 & 16 bits & 731 & 0.0485 & $0.0467$--$0.0496$ & 5 & --- & all 65{,}535 \checkmark \\
24 & posit32 & 32 bits & 1031 & 0.0302 & $0.0291$--$0.0314$ & 5 & --- & all 40{,}000 \checkmark \\
25 & IBM hex32 & 32 bits & 1072 & 0.0292 & $0.0273$--$0.0297$ & 5 & --- & all 40{,}000 \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
2 & \textbf{GFTernary} & 527 & 82.93 & 0.1574 \\
8 & fp8 e4m3 & 549 & 68.30 & 0.1244 \\
8 & fp8 e5m2 & 544 & 66.05 & 0.1214 \\
8 & minifloat & 622 & 66.87 & 0.1075 \\
8 & \textbf{GF+8} & 692 & 61.06 & 0.0882 \\
8 & posit8 & 614 & 44.71 & 0.0728 \\
10 & \textbf{GF10} & 597 & 70.96 & 0.1189 \\
10 & \textbf{TNF8} & 609 & 65.08 & 0.1069 \\
14 & \textbf{GF14} & 651 & 69.91 & 0.1074 \\
16 & \textbf{TNF16a} & 566 & 69.77 & 0.1233 \\
16 & \textbf{TNF16c} & 591 & 68.35 & 0.1157 \\
16 & \textbf{TNF16b} & 604 & 63.31 & 0.1048 \\
16 & binary16 & 586 & 60.90 & 0.1039 \\
16 & takum16 & 853 & 59.31 & 0.0695 \\
16 & LNS16 & 722 & 43.15 & 0.0598 \\
16 & posit16 & 731 & 35.43 & 0.0485 \\
17 & \textbf{TNF17e} & 596 & 71.94 & 0.1207 \\
17 & \textbf{TNF17e-bare} & 605 & 64.87 & 0.1072 \\
17 & \textbf{BNF16} & 635 & 65.68 & 0.1034 \\
17 & \textbf{TNF16} & 629 & 63.22 & 0.1005 \\
