...
pricing one of four paths. \emph{Four of the competitors' decoders are
incomplete}: takum16 disagrees with its reference on $98.7\%$ of its codes, IBM
hex32 on $28\%$, and \texttt{fp8} omits subnormals entirely, which makes those
rows lower bounds on what a complete implementation would cost. Every error
