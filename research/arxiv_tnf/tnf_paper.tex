...
\midrule
sq.\ error, best encoder both sides & $14.10\%$ & $14.01\%$ & --- & --- & $\mathbf{1.01\times}$ \\
sq.\ error, against Algorithm~1     & $17.11\%$ & $16.42\%$ & --- & --- & $1.04\times$ \\
perplexity, best encoder both sides & $9.50\%$  & $7.18\%$  & $12.38\%$ & $7.19\%$ & $\mathbf{1.72\times}$ \\
perplexity, against Algorithm~1     & $20.25\%$ & $9.16\%$  & $12.31\%$ & $6.74\%$ & $\mathbf{3.00\times}$ \\
\bottomrule
\end{tabular}
\end{center}
Two axes order the transferability and both point the same way. \emph{Squared
error transfers and perplexity does not}; \emph{best-against-best transfers and
against-the-reference-encoder does not.} \textbf{The least transferable of the
four is the combination most often quoted.} Two further models keep the second
axis intact without flattering it: at four models the best-against-best row
spreads $1.72\times$ and the against-Algorithm-1 row $3.00\times$. The gap
narrowed when Pythia was added --- from $1.32$ against $3.00$ at three models to
$1.72$ against $3.00$ at four --- and we report the narrowing rather than
stopping at the more favourable count.
\end{proposition}
