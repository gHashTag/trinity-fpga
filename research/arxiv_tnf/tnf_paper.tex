...
exceeds it for $137$ of the first $200$ values of $b$. The positive half of the
...
the width never falls below $E_t^{*} = \lceil\log_3(b+1)\rceil$; that it strictly
exceeds it for $137$ of $b = 1 \ldots 200$ is by enumeration. The indices
...
$E_t^{*}(b) = \lceil\log_3(b+1)\rceil$, and the width rule $1 + E_t + M = N$ fixes
