...
common $128$-bit harness. Welch against \texttt{binary16} with Holm correction
over the eight comparisons; every one survives.}
\label{tab:fiftyfour}
\small
\begin{tabular}{lrrrl}
\toprule
