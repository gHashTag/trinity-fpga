...
total disagreed by exactly that one entry, and the member list decided it.}
\label{tab:taxonomy}
\begin{tabular}{llrl}
\toprule
...
regime is below one bit everywhere above the 8-bit class.}
\label{tab:oneoverm}
\begin{tabular}{rrrr}
\toprule
...
quantisation scheme for neural radio receivers~\cite{fiandaca2025fibbinary}, and
...
draft~\cite{wintersteiger2025formal} --- but we found no study of conformance-vector
...
mixture & $0$ outliers & 11.3 & 7.09e-4 & 1.44e-4 & 0.20 & 0.25 \\
...
has no representation at all from $c=20$ upward, marked ---. \emph{Data:} \texttt{measurements/crossover2\_2026-08-13e.json}}
\label{tab:window}
...
4 & 6.80e-4 & 2.96e-4 & 1.69e-4 & 0.43 & 0.25 \\
...
\hline
\texttt{h.0.attn.c\_proj} & $-5.3$ & $0.2$ & 7.02e-4 & 3.87e-4 & 1.78e-4 & 0.55 \\
...
rather than reported. $7000$ samples per row, seed $20260813$. $\dagger$ marks an
...
win columns are the extreme $D$ values on either side of the separating interval.}
\label{tab:rungthr}
\begin{tabular}{lrrrrl}
\hline
pair & cells & reach & comp. & threshold & separates? \\
\hline
TNF$(4,8)$ / \texttt{takum16} & $16$ & $\pm 40$ & $30$ & $D \gtrsim 9.5$ & yes, $8.99 \to 10.01$ \\
TNF$(5,23)$ / \texttt{takum32} & $32$ & $\pm 121$ & $51$ & $D \gtrsim 21.9$ & yes, $19.86 \to 23.87$ \\
TNF$(6,21)$ / \texttt{takum32} & $32$ & $\pm 364$ & $58$ & none & no, $0$ wins in $58$ \\
\hline
\end{tabular}
\end{table}
...
tail leaves the $\pm 40$ binade reach of the $(4,8)$ rung long before $D$ reaches
...
representable in the TNF rung; when it is no, no ratio exists and none is
...
\texttt{takum} represents all of them, at low accuracy but without loss. This is
...
$\pm 40$ binades and the $(5,23)$ rung $\pm 121$.
...
\bibitem{wintersteiger2025formal} C.~M.~Wintersteiger, ``Formal Verification of the IEEE P3109 Standard for Binary Floating-point Formats for Machine Learning,'' in \emph{Proc.\ 2025 IEEE 32nd Symp.\ Computer Arithmetic (ARITH)}, pp.~157--160, DOI 10.1109/ARITH64983.2025.00032.
...
\bibitem{fiandaca2025fibbinary} R.~Fiandaca and M.~D.~Gomony, ``Fibbinary-Based Compression and Quantization for Efficient Neural Radio Receivers,'' arXiv:2511.01921. \url{https://arxiv.org/abs/2511.01921}
