...
3 & \textbf{GF10} (ours) & 10 bits & 533 & 72.16 & \textbf{0.1354} & $5.08$ & all 1{,}024 \\
4 & fp8 e4m3 & 8 bits & 516 & 64.70 & 0.1254 & $9.33$ & all 256, 0 wrong \\
5 & fp8 e5m2 & 8 bits & 529 & 65.30 & 0.1234 & $5.70$ & all 256, 0 wrong \\
6 & binary16 & 16 bits & 522 & 63.30 & 0.1213 & $7.74$ & all 65{,}536 \\
7 & \textbf{GF14} (ours) & 14 bits & 587 & 71.15 & \textbf{0.1212} & $4.54$ & all 16{,}384 \\
8 & minifloat & 8 bits & 558 & 67.06 & 0.1202 & $5.49$ & not swept \\
9 & \textbf{BNF16} (ours) & 17 bits & 571 & 67.13 & \textbf{0.1176} & $3.30$ & all 131{,}072, 0 wrong \\
10 & \textbf{TNF32} (ours) & 36 bits & 569 & 66.91 & \textbf{0.1176} & $6.03$ & sampled 9{,}997, 0 wrong \\
11 & \textbf{TNF16} (ours) & 17 bits & 565 & 66.28 & \textbf{0.1173} & $8.56$ & all 131{,}072 \\
12 & \textbf{TNF64} (ours) & 65 bits & 572 & 65.38 & \textbf{0.1143} & $8.73$ & sampled, 0 wrong \\
13 & \textbf{TNF8} (ours) & 10 bits & 545 & 62.13 & \textbf{0.1140} & $3.63$ & all 1{,}024, 0 wrong \\
14 & VAX F & 32 bits & 560 & 61.38 & 0.1096 & $3.71$ & all 40{,}000 \checkmark \\
...
17 & takum16 & 16 bits, 57 BRAM & 789 & 58.96 & 0.0747 & $5.75$ & 632 of 61{,}505 (fp32 floor) \\
18 & LNS16 & 16 bits & 658 & 43.04 & 0.0654 & $0.45$ & not swept \\
19 & posit16 & 16 bits & 712 & 40.38 & 0.0567 & $1.02$ & 4 of 65{,}536 wrong \\
20 & IBM hex32 & 32 bits & 1008 & 30.82 & 0.0306 & $1.53$ & all 40{,}000 \checkmark \\
...
posit16   & $4$      & $4/65{,}535$   & unchanged: a real edge defect \\
posit32   & $36$     & $48/40{,}000$  & unchanged: a real defect, count corrected \\
\bottomrule
\end{tabular}
\end{table}

Four of the six shrank to nothing or nearly nothing, and two did not. That ratio
...
attention than the two real ones. \emph{The instrument was inside the failure
