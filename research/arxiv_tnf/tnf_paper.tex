...
bit observed, median of five placement seeds. \texttt{int8} is reported in
Table~\ref{tab:rejected}. The last column is what decides how much the rest of
the row is worth: every code of each 8- and 16-bit format was swept through the
same RTL that was synthesised and compared against its reference.
\textbf{TNF16 is at $17$ bits here}, the width its reference specifies, after
the sixteen-bit module we first measured was found to disagree on all $65{,}536$
of its codes --- it had one mantissa bit too few, and the correction costs it
eight places. Three of ours have no reference to check against, and are marked
so rather than presented as verified.}
...
3 & \textbf{TNF32} (ours) & 32 bits & 492 & 75.57 & \textbf{0.1536} & $10.15$ & no reference \\
4 & \textbf{TNF64} (ours) & 64 bits & 494 & 75.16 & \textbf{0.1521} & $7.87$ & no reference \\
5 & \textbf{BNF16} (ours) & 16 bits & 518 & 74.94 & \textbf{0.1447} & $12.28$ & no reference \\
6 & \textbf{GF+8} (ours) & 8 bits & 510 & 72.84 & \textbf{0.1428} & $4.77$ & no reference \\
7 & fp8 e5m2 & 8 bits & 480 & 67.06 & 0.1397 & $5.46$ & 6 of 256 wrong \\
8 & VAX F & 32 bits & 527 & 73.51 & 0.1395 & $4.43$ & not swept \\
9 & fp8 e4m3 & 8 bits & 485 & 67.02 & 0.1382 & $6.78$ & 14 of 256 wrong \\
10 & \textbf{GF10} (ours) & 10 bits & 533 & 72.16 & \textbf{0.1354} & $5.08$ & all 1{,}024 \\
11 & binary16 & 16 bits & 522 & 63.30 & 0.1213 & $7.74$ & all 65{,}536 \\
12 & \textbf{GF14} (ours) & 14 bits & 587 & 71.15 & \textbf{0.1212} & $4.54$ & all 16{,}384 \\
13 & minifloat & 8 bits & 558 & 67.06 & 0.1202 & $5.49$ & not swept \\
14 & \textbf{TNF16} (ours) & 17 bits & 565 & 66.28 & \textbf{0.1173} & $8.56$ & all 131{,}072 \\
15 & posit8 & 8 bits & 540 & 44.33 & 0.0821 & $4.02$ & not swept \\
16 & takum16 & 16 bits & 789 & 58.96 & 0.0747 & $5.75$ & not swept \\
17 & IBM hex32 & 32 bits & 687 & 46.78 & 0.0681 & $3.78$ & not swept \\
18 & LNS16 & 16 bits & 658 & 43.04 & 0.0654 & $0.45$ & not swept \\
19 & posit16 & 16 bits & 712 & 40.38 & 0.0567 & $1.02$ & 4 of 65{,}536 wrong \\
20 & posit32 & 32 bits & 953 & 28.16 & 0.0295 & $2.29$ & not swept \\
\bottomrule
\end{tabular}
\end{table}
