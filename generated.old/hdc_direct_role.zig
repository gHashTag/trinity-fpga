...
// Test computeDirectRole: verify behavior is callable
const func = @TypeOf(computeDirectRole);
...
// Test refineDirectRole: verify behavior is callable
const func = @TypeOf(refineDirectRole);
    try std.testing.expect(func != void);
}
