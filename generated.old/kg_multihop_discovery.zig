...
// Test relationDiscovery: verify behavior is callable
const func = @TypeOf(relationDiscovery);
...
// Then: 100% discovery (10/10)
// Test twoHopChainDiscovery: verify behavior is callable
const func = @TypeOf(twoHopChainDiscovery);
    try std.testing.expect(func != void);
}
...
// When: Traverse 3 hops sequentially
// Then: 100% discovery (10/10)
// Test threeHopChainDiscovery: verify behavior is callable
const func = @TypeOf(threeHopChainDiscovery);
    try std.testing.expect(func != void);
}
