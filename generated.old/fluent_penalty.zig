...
pub fn generateWithPenalty() !void {
...
// Degeneration reduced (2→30 unique), but not fluent English sentences — diverse vocabulary fragments
...
// When: Generate 30 words at T=0.3, T=0.8
// Then: T=0.3 diverse (17/32 unique), T=0.8 highly diverse (29/32 unique), no repeated trigrams
// Test generateWithPenalty: verify behavior is callable
const func = @TypeOf(generateWithPenalty);
