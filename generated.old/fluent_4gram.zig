...
pub fn assessChainRecall() !void {
// Output is verbatim Shakespeare — memorized, not generated
...
// When: Generate 30 words from "to be or" at T=0.3 and T=0.8
// Then: T=0.3 recalls Hamlet soliloquy (memorized chain), T=0.8 diverse
// Test generate4gram: verify behavior is callable
const func = @TypeOf(generate4gram);
...
// When: Compare output to training corpus text
// Then: Output is verbatim Shakespeare — memorized, not generated
// Test assessChainRecall: verify behavior is callable
const func = @TypeOf(assessChainRecall);
    try std.testing.expect(func != void);
}
