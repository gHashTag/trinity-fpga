...
const evaluate_scaling_need = evaluateScalingNeed;
const check_scale_cooldown = checkScaleCooldown;
const execute_scale = executeScale;
const predict_workload = predictWorkload;
const get_pool_efficiency = getPoolEfficiency;
const enforce_cost_limit = enforceCostLimit;
const get_scaling_stats = getScalingStats;
