...
// Test massiveWeightedConstruction: verify behavior is callable
const func = @TypeOf(massiveWeightedConstruction);
...
// Test weightClassCorrelation: verify behavior is callable
const func = @TypeOf(weightClassCorrelation);
    try std.testing.expect(func != void);
}
...
// Test fullAccuracy: verify behavior is callable
const func = @TypeOf(fullAccuracy);
    try std.testing.expect(func != void);
}
