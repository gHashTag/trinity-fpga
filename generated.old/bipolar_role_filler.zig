...
// Test bipolarFrameBuild: verify behavior is callable
const func = @TypeOf(bipolarFrameBuild);
...
// Test bipolarFrameDecompose: verify behavior is callable
const func = @TypeOf(bipolarFrameDecompose);
    try std.testing.expect(func != void);
}
...
// Test bipolarVsTernarySignal: verify behavior is callable
const func = @TypeOf(bipolarVsTernarySignal);
    try std.testing.expect(func != void);
}
