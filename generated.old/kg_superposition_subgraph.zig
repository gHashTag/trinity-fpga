...
// Test bundleSubgraphs: verify behavior is callable
const func = @TypeOf(bundleSubgraphs);
...
// Test querySubgraphFacts: verify behavior is callable
const func = @TypeOf(querySubgraphFacts);
    try std.testing.expect(func != void);
}
...
// Test noisySubgraphQuery: verify behavior is callable
const func = @TypeOf(noisySubgraphQuery);
    try std.testing.expect(func != void);
}
