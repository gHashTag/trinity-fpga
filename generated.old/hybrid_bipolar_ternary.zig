...
// Test hybridAnalogy: verify behavior is callable
const func = @TypeOf(hybridAnalogy);
...
// Test hybridMultiHop: verify behavior is callable
const func = @TypeOf(hybridMultiHop);
    try std.testing.expect(func != void);
}
...
// Test hybridSelection: verify behavior is callable
const func = @TypeOf(hybridSelection);
    try std.testing.expect(func != void);
}
