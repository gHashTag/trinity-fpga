...
pub const DEFAULT_MODEL_PATH: f64 = 0;

pub const FALLBACK_TIMEOUT_MS: f64 = 5000;

pub const MAX_CONTEXT_LENGTH: f64 = 2048;

pub const DEFAULT_MAX_TOKENS: f64 = 512;
...
/// FallbackConfig with provider chain
...
/// FallbackConfig and provider health states
...
/// GenerationRequest and selected provider
...
/// GenerationRequest for local GGUF
...
/// GenerationRequest for cloud provider
...
/// Failed request and remaining providers
