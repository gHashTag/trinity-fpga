...
const detect_failure = detectFailure;
const determine_recovery_action = determineRecoveryAction;
const execute_recovery = executeRecovery;
const check_recovery_cooldown = checkRecoveryCooldown;
const log_recovery_attempt = logRecoveryAttempt;
const get_healing_stats = getHealingStats;
const escalate_failure = escalateFailure;
