...
// Test resonatorTrainStep: verify behavior is callable
const func = @TypeOf(resonatorTrainStep);
...
// Test computeIdealRoles: verify behavior is callable
const func = @TypeOf(computeIdealRoles);
    try std.testing.expect(func != void);
}
...
// Test applyBindCorrection: verify behavior is callable
const func = @TypeOf(applyBindCorrection);
    try std.testing.expect(func != void);
}
