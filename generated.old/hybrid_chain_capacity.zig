...
// Test bipolarExactChains: verify behavior is callable
const func = @TypeOf(bipolarExactChains);
...
// Test ternarySuperpositionCapacity: verify behavior is callable
const func = @TypeOf(ternarySuperpositionCapacity);
    try std.testing.expect(func != void);
}
...
// Test hybridBestOfBoth: verify behavior is callable
const func = @TypeOf(hybridBestOfBoth);
    try std.testing.expect(func != void);
}
